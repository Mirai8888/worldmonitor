...
export class CountryDeepDivePanel implements CountryBriefPanel {
  ...
  private renderInitialSignals(signals: CountryBriefSignals): void {
    ...
    this.addSignalChip(chips, signals.militaryFlights, t('countryBrief.chips.militaryAir'), '', 'military');
    ...
    this.addSignalChip(chips, signals.radiationAnomalies, 'Radiation anomalies', '', 'outage');
    this.addSignalChip(chips, signals.temporalAnomalies, t('countryBrief.chips.temporalAnomalies'), '', 'outage');
    this.addSignalChip(chips, signals.cyberThreats, t('countryBrief.chips.cyberThreats'), '', 'conflict');
    ...
    this.addSignalChip(chips, signals.climateStress, t('countryBrief.chips.climateStress'), '', 'climate');
    this.addSignalChip(chips, signals.conflictEvents, t('countryBrief.chips.conflictEvents'), '', 'conflict');
    ...
    if (signals.travelAdvisories > 0 && signals.travelAdvisoryMaxLevel) {
      ...
      chips.append(this.makeSignalChip(` ${signals.travelAdvisories} ${t('countryBrief.chips.advisory')}: ${advLabel}`, 'advisory'));
    }
  ...
  private renderComponentBars(components: CountryScore['components']): HTMLElement {
    ...
    const items = [
      ...
      { label: t('countryBrief.components.security'), value: components.security, icon: '' },
